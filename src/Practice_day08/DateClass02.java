...
public class DateClass02 {
    public static void main(String[] args) {
        ...
        LocalDate startDate = LocalDate.of(2023,1,20);//Başlangıç tarihibi belirledik
        LocalDate futureDate = calculateFuturDate(startDate, 206); //120 gün sonrasını hesaplayacak
